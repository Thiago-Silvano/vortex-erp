...
import BuscarServicosRobot from "./pages/BuscarServicosRobot";
...
import RoteiroPremiumPage from "./pages/roteiro/RoteiroPremiumPage";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/settings/api-integrations" element={<ProtectedRoute><ApiIntegrationsPage /></ProtectedRoute>} />
          ...
          <Route path="/cotacao/buscar-servicos" element={<ProtectedRoute><BuscarServicosRobot /></ProtectedRoute>} />
