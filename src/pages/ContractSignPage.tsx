...
export default function ContractSignPage() {
  ...
  const loadContract = async () => {
    ...
    await supabase.from('contract_audit_log').insert({
      ...
      ip_address: '', details: { user_agent: navigator.userAgent }
    } as any);
  ...
  const handleSign = async () => {
    ...
    await supabase.from('contract_audit_log').insert({
      ...
      details: { signature_type: sigType, document_hash: docHash, verification_method: 'email_otp' }
    } as any);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 mb-6">
          {['Ler Contrato', 'Verificar Identidade', 'Assinar'].map((label, i) => {
