    ...
    <div className="space-y-6">
      ...
      {mostraEmpregador && (
        <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50/60 p-4">
          <TextField label="Cargo" error={errors?.cargo} value={data.cargo} onChange={v => onChange('cargo', v)} />
          <TextField label="Nome do empregador" error={errors?.empresa_nome} value={data.empresa_nome} onChange={v => onChange('empresa_nome', v)} />
      ...
      {isEstudante && (
        <div className="space-y-4 rounded-lg border border-slate-200 bg-slate-50/60 p-4">
          <TextField label="Nome da escola/faculdade" error={errors?.empresa_nome} value={data.empresa_nome} onChange={v => onChange('empresa_nome', v)} />
